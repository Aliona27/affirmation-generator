...
function generateAffirmation(event) {
  ...
  affirmationElement.innerHTML = `Generating your affirmation about ${userInput.value.toLowerCase()}🪄<span class="blink">✨</span>`;
  axios.get(apiUrl).then(displayAffirmation);
}

let affirmationElement = document.querySelector("#affirmation");
let affirmation = `You are exactly where you need to be!💫 <br />
          Trust the process of life and enjoy your unique path💜`;
